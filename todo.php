...
<body>
    ...
    <form action="todob.php" method="POST">
        <input type="text" placeholder="--Title here--" required name="title" class="text1">
        <textarea class="text2" name="desc" required placeholder="--Description Here--"></textarea><br>
